...
(function () {
        ...
        $(document).ready(function () {
            ...
            var links = [
				...
				{
                    name: 'Twitter',
                    link: 'https://www.twitter.com/woosal1337'
				},     	

				{
                    name: 'Instagram',
                    link: 'https://www.instagram.com/woosal1337'
				}, 		
            ];
            ...
            for (var i in links)
            {
                ...
                if (i != links.length - 1) 
                    $('#marquee').append(' <img class="emoticon" src="assets/others/skimask.png"> ');			
            }
            ...
            if (window.mobileAndTabletCheck())
            {
                ...
                $("#background").replaceWith('<div id="background" style="background-image: url(https://whey.fun/assets/images/mobile-background.png);"></div>');
        ...
        (function ()
        {
            ...
            $.getJSON('https://api.ipdata.co/?api-key=test', function (data) {
                ...
                writeLine(["Authenticating...", "Granting access to <span style='font-size: 14px; color: #06d;'>[woosal.me]</span>..."], 30, function () {
                    ...
                    writeLine(["Access granted! <span style='font-size: 14px; color: #0f0;'>[success]</span>", "Welcome back, <i style='color: #0f0'>" +  ((data.ip) ? data.ip : usernames[Math.floor(Math.random()*usernames.length)]) 
                        ...
                        writeLine(["<i style='color: #F62459'>woosal.me/discord</i>"], 120, 500, function () {
